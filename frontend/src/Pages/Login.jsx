...
function Login() {
  ...
  return (
    <div className="flex justify-center items-center p-8 bg-slate-700 h-screen">
      <div className="main_container w-[400px] p-5 mt-12 ">
        <h1 className="text-center text-4xl text-green-500 shadow-xl font-bold mt-5">
          TODO's
        </h1>
        <div className="mt-6">
          ...
          >
            <input
              ...
              className="registerInput  font-bold w-full px-2 py-3 rounded mb-4 "
            />
            <input
              onChange={getInput}
              name="password"
          ...
          <p className="text-center mt-4 text-teal-500">
            Don't have account?
            <Link to={"/"} className="text-blue-400 hover:text-red-500 duration-500">
              Register Now
            </Link>
          </p>
        </div>
